...
<div class="col-md-12">
	<div class="single_img_wrap covid-banner">
		<img src="/wp-content/uploads/2020/04/OPSI-Covid19-Tracker-banner.jpg"
		     class="attachment-blog size-blog wp-post-image" alt="OPSI COVID-19 Innovative Response Tracker">
	</div>
</div>
		...
		<div class="row">
			<div class="col-md-9">
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<h2><?php echo __( 'Innovative response', 'opsi' ); ?></h2>
					<div class="csp"><?php echo $fields['information_about_the_response']['innovative_response_description']['text'] ?></div>

					<h2><?php echo __( 'Specific issues addressed and anticipated impact', 'opsi' ); ?></h2>
					<div class="csp"><?php echo $fields['information_about_the_response']['specific_issue_addressed']['text'] ?></div>

					<?php if ( $fields['information_about_the_response']['organisations_involved']['text'] != '' ) { ?>
						<h2><?php echo __( 'Organisations/institutions involved', 'opsi' ); ?></h2>
					...
					<?php if ( $fields['information_about_the_response']['potential_issues']['text'] != '' ) { ?>
						<h2><?php echo __( 'Potential issues', 'opsi' ); ?></h2>
						...
						<?php if ( $iso != '' ) { ?>
							<div class="col-xs-4">
								<a href="<?php echo get_post_type_archive_link( 'covid_response' ); ?>?_countries=<?php echo $country[0]->slug; ?>"
								   title="<?php echo __( 'All innovations by:', 'opsi' ); ?> <?php echo $country[0]->name; ?>"
								   class="blacklink" target="_blank">
									<img src="<?php echo get_stylesheet_directory_uri() . '/images/flags/' . $iso . '.png'; ?>"
									     width="96" height="96" alt="<?php echo $country[0]->name; ?>" class="cs_flag"/>
								</a>
							</div>
						<?php } ?>
				...
				<div class="cs_sidebar_wrap">
					<div class="row">
						<div class="col-md-12">
							...
							<span class="strong truncate">
								<a href="<?php echo $fields['information_about_the_response']['other_urls']['text']; ?>"
								   title="<?php echo __( 'additional URL', 'opsi' ); ?>" target="_blank">
					...
					<div class="cs_sidebar_wrap">
						<div class="row">
							<div class="col-xs-12">
								...
								<span class="strong truncate">
  								<a href="mailto:<?php echo $fields['information_about_the_response']['email_public']['text']; ?>"
							       target="_blank">
