	...
	<div class="row">
      ...
      <?php comments_template(); ?>
		...
		<div class="col-md-3 case_study_sidebar">
          ...
          <?php if ( !empty( $fields['organisation_details']['organisation_type'] ) ) { ?>
						<div class="log_wrap">
							<span class="sidebar_label"><?php echo __( 'Organisation Type:', 'opsi' ); ?></span>
							<span class="strong"><?php echo $fields['organisation_details']['organisation_type']['text']['label']; ?></span>
						</div>
					<?php } ?>

					<?php if ( !empty( $fields['organisation_details']['level_of_government'] ) && 'government' == $fields['organisation_details']['organisation_type']['text']['value'] ) { ?>
						<div class="log_wrap">
